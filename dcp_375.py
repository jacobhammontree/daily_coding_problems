...
def calcHIndex(paper_citations):
    hIndex = [ind for ind,x in enumerate(reversed(sorted(paper_citations))) if x<=ind]
    return hIndex[0]


print(calcHIndex([4,0,0,2,3]))
print(calcHIndex([10, 8, 5, 4, 3]))
print(calcHIndex([10, 8, 5, 3, 3]))